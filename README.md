...
`TON-210 — Run render and memory benchmark with 300 crop objects`

The repository currently contains the validated farm-map contract, player movement prototype and a reproducible crop-render benchmark. Production gameplay, art and deployment are tracked separately in Linear.
...
The domain and data validation layers are intentionally isolated from Phaser so farming rules, content contracts, benchmark statistics and save migration can be tested without booting a renderer.
