...
Browser evidence records the active player texture/frame/animation, origin/body/foot anchor/depth, environment frames, crop frame and independent impact-dispatch/domain-commit counters. Real-device Safari and final illustration quality remain outside automated acceptance.
