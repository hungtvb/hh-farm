...
const VI_STRINGS = Object.freeze({
  ...
  'hud.defaultObjectiveHint': 'Chạm ô đất để nhân vật tự đi tới',
  ...
  'farm.step.till.hint': 'Chạm ô đất để nhân vật tự đi tới và xới.',
  'farm.step.plant.title': 'Gieo một hạt củ cải',
  'farm.step.plant.hint': 'Chạm lại ô đất đã xới để gieo hạt củ cải.',
  'farm.step.water.title': 'Tưới cây trước khi ngủ',
  'farm.step.water.hint': 'Chạm ô cây để nhân vật tưới trước khi ngủ.',
  'farm.step.next_day.title': 'Ngủ qua ngày',
  'farm.step.next_day.hint': 'Chạm vào giường để qua ngày; tiến độ sẽ tự lưu.',
  'farm.step.harvest.title': 'Thu hoạch củ cải đã chín',
  'farm.step.harvest.hint': 'Chạm cây trưởng thành để nhân vật thu hoạch.',
  'farm.step.sell.title': 'Bán một củ cải',
  'farm.step.sell.hint': 'Chạm thùng vận chuyển để bán củ cải.',
  'farm.step.completed.title': 'Vòng lặp nông trại đã hoàn thành',
  'farm.step.completed.hint': 'Vòng đầu đã xong — tiếp tục chạm trực tiếp vào nông trại.',
  'farm.free.title': 'Chế độ tự do',
  'farm.free.hint': 'Chạm trực tiếp vào ô đất và vật thể để làm nông.',
...
const EN_STRINGS: Readonly<Record<GameStringKey, string>> = Object.freeze({
  ...
  'hud.defaultObjectiveHint': 'Tap a plot and the character will approach',
  'shop.toggle': 'Shop',
  ...
  'farm.step.till.hint': 'Tap a plot and the character will walk over to till it.',
  'farm.step.plant.title': 'Plant one turnip seed',
  'farm.step.plant.hint': 'Tap the tilled plot again to plant a turnip seed.',
  'farm.step.water.title': 'Water the crop before sleeping',
  'farm.step.water.hint': 'Tap the crop so the character waters it before bed.',
  'farm.step.next_day.title': 'Sleep until tomorrow',
  'farm.step.next_day.hint': 'Tap the bed to advance the day; progress autosaves.',
  'farm.step.harvest.title': 'Harvest the mature turnip',
  'farm.step.harvest.hint': 'Tap the mature crop and the character will harvest it.',
  'farm.step.sell.title': 'Sell one turnip',
  'farm.step.sell.hint': 'Tap the shipping bin to sell the turnip.',
  'farm.step.completed.title': 'Farm loop complete',
  'farm.step.completed.hint': 'The first loop is complete — keep tapping the farm directly.',
  'farm.free.title': 'Free play',
  'farm.free.hint': 'Tap plots and world objects directly to farm.',
